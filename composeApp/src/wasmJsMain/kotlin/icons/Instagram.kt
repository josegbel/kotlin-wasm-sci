...
public val SocialMediaPack.Instagram: ImageVector
    get() {
        if (_instagram != null) {
            return _instagram!!
        }
        _instagram = Builder(name = "Instagram", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(1.44f, 1.44f, 0.0f, false, false, -1.437f, 1.4424f)
                ...
                moveTo(8.0f, 12.0077f)
                arcToRelative(4.0f, 4.0f, 0.0f, true, true, 4.008f, 3.9921f)
                arcTo(3.9996f, 3.9996f, 0.0f, false, true, 8.0f, 12.0077f)
            }
        }
        .build()
        return _instagram!!
