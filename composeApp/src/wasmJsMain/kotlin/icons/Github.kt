...
public val SocialMediaPack.Github: ImageVector
    get() {
        if (icons._github != null) {
            return icons._github!!
        }
        icons._github = Builder(name = "Github", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
